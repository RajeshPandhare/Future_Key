...
class Contactus extends React.Component {
   ...
   onSubmit = () => {
       ...
       this.props.fetchProductAction(this.state);
    }
               ...
               <div class="col-md-6 col-sm-12">
                  <div class="block">
                     <div class="form-group">
                        <input name="user_name" type="text" name='name' onChange={this.updateInputValue} value={this.state.name} class="form-control" placeholder="Your Name" />
                     </div>
                     <div class="form-group">
                        <input name="user_email" type="text" name='email'  onChange={this.updateInputValue} value={this.state.email} class="form-control" placeholder="Email Address" />
                     </div>
                     <div class="form-group">
                        <input name="user_mobile" type="text" name='mobile' onChange={this.updateInputValue} value={this.state.mobile} class="form-control" placeholder="mobile" />
                     </div>
                  </div>
               </div>
               <div class="col-md-6 col-sm-12">
                  <div class="block">
                     <div class="form-group-2">
                        <textarea name="user_message" name='msg' onChange={this.updateInputValue} value={this.state.msg} class="form-control" rows="4"
                           placeholder="Your Message"></textarea>
                     </div>
                     <button onClick={this.onSubmit} class="btn btn-default" >Send Message</button>
                  </div>
               </div>
...
export default withRouter(connect(mapStateToProps, { fetchProductAction })(Contactus))